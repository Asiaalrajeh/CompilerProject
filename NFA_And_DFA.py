...
# r = Tk()
# r.title('compiler project') # chang title
# r.geometry("300x400")
...
class Automata:
    ...
    def display(self):
        ...
        Label(r, text= "First state:").place(x=10,y=30)
        Label(r, text= str(self.startstate) ).place(x=80,y=30)
        print ("final states:", self.finalstates)
        Label(r, text= "Final states:").place(x=10,y=60)
        Label(r, text= str(self.finalstates) ).place(x=80,y=60)
        print ("transitions:")
        Label(r, text= "Transitions: ").place(x=10,y=90)
        o = 80
        x = 90
        for fromstate, tostates in self.transitions.items():
            for state in tostates:
                for char in tostates[state]:
                    ...
                    # Label(r, text= " "+ char +"\n").place(x=x,y=o)  
                    h= Label(r, text= " "+ str(fromstate) +" --"+ char +"> "+ str(state))
                    h.pack()
